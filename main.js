...
for (let i = 0; i < arreglo_cadena.length; i++) {
  ...
  /*
    recomiendo usar "===" para hacer mejores comparaciones y buenas practicas!
  */
...
/*
  Intente buscar otra logica para darte otra forma de hacerlo, hay muchas! 
  Pero esta es la mejor... Bien ahi! Me gusta, divertido y buena logica
*/